...
cmd_help() {
  ...
  echo ""
  echo "Commands:"
  echo -e "  ${BOLD}mock${NC}          Start the full stack with mock/demo data (no GCP needed)"
  echo -e "  ${BOLD}live${NC}          Start the full stack scanning a real GCP project"
  echo -e "  ${BOLD}infra-up${NC}      Provision the GCP demo project via Terraform"
  echo -e "  ${BOLD}infra-down${NC}    Tear down the GCP demo resources"
  echo -e "  ${BOLD}test${NC}          Run the pytest suite"
  echo -e "  ${BOLD}stop${NC}          Stop all running demo processes"
  echo -e "  ${BOLD}status${NC}        Show running demo processes"
  echo ""
